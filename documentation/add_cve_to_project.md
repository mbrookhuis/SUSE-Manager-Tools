...
This script is used to add a list of CVEs to a project the first environment of the project. The addition is both the errata information and the involved packages. 
...
* -c CVE, --cve CVE → The CVE Number. This option can be used multuple times Required
...
> /opt/uyuni-tools/add_cve_to_project.py -p s157-sap -u -c CVE-2025-8058 -c CVE-2022-22967
